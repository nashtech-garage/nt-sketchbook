...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex h-9 w-full items-center justify-between text-shade-neutral-70 whitespace-nowrap rounded-md',
    ...
    >
        ...
        <SelectPrimitive.Icon asChild>
            <ChevronDown className="h-4 w-4 text-shade-neutral-70" />
...
>(({ className, children, position = 'popper', ...props }, ref) => (
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ref={ref}
            className={cn(
                'text-sm relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border',
                ' bg-white text-shade-neutral-70 shadow-md',
