...
import { Button } from '@share/apps/nt-headless-ui/components/radix/button'
import { Input } from '@share/apps/nt-headless-ui/components/radix/input'
import { Separator } from '@share/apps/nt-headless-ui/components/radix/separator'
import {
    Sheet,
    SheetContent,
    SheetDescription,
    SheetHeader,
    SheetTitle,
} from '@share/apps/nt-headless-ui/components/radix/sheet'
import { Skeleton } from '@share/apps/nt-headless-ui/components/radix/skeleton'
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
    TooltipTrigger,
} from '@share/apps/nt-headless-ui/components/radix/tooltip'
...
>(({ className, ...props }, ref) => (
    <ul
        ...
        className={cn(
            'pl-6 flex min-w-0 translate-x-px flex-col gap-2 mt-3',
            'group-data-[collapsible=icon]:hidden',
            className,
        )}
        {...props}
