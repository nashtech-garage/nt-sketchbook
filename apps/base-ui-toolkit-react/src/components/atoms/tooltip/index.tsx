  ...
  return (
    <div className="group relative inline-flex justify-center items-center">
      ...
      >
        <BiSolidLeftArrow
          size={15}
          className={combineClasses('text-gray-800 absolute', {
            '-left-2.5 top-2.5': position === 'right',
            '-right-2.5 top-2.5 rotate-180': position === 'left',
            '-bottom-2.5 -rotate-90': position === 'top',
            '-top-2.5 rotate-90': position === 'bottom',
          })}
        />
        {message}
      </div>
